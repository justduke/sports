               ...
               <div class="carousel-inner" role="listbox">
                     ...
                     <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                           <div class="slider-contant" data-animation="animated fadeInRight">
                              <h3 class="color-black">If you Can't Practice<br>You <span class="color-yellow">Don’t Derserve</span><br>to win!</h3>
                  ...
                  <div class="item skyblue" data-ride="carousel" data-interval="5000">
                     <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                           <div class="slider-contant" data-animation="animated fadeInRight">
                              <h3>If you Practice<br>You <span class="color-yellow">Don’t Derserve</span><br>to win!</h3>
               ...
               <div class="col-lg-4 col-sm-4 col-xs-12">
                  <aside id="sidebar" class="left-bar">
                     <div class="banner-sidebar">
                        <img class="img-responsive" src="images/img0302.png" alt="#" />
                        <h3>Athlete's TIME measures the power to win </h3>
                     </div>
                  </aside>
                  <h4>Upcoming RUN Fixture</h4>
                  <aside id="sidebar" class="left-bar">
                        ...
                        <div class="team-btw-match">
                           <ul>
                              <li>
                                 ...
                                 <span>AFRO-RUN-001</span>
                              </li>
                              <li class="vs"><span>at</span></li>
                              <li>
               ...
               <div class="col-lg-8 col-sm-8 col-xs-12">
                  <div class="news-post-holder">
                     <div class="news-post-widget">
                        <img class="img-responsive" src="images/img-stry.jpg" alt="" height="100px">
                  ...
                  <div class="news-post-holder">
                     <div class="news-post-widget run-list">
                        <!-- <img class="img-responsive" src="images/sprint.jpg" alt="" height="100px"> -->
                        <div class="news-post-detail align-center">
                          
                           <h2 class="fa-align-center"><a href="listing.php"><button class="btn btn-primary" type=""> View Athletes Listing </button></a></h2>
